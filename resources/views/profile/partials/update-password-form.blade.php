<section>
    <header class="flex items-start gap-4 border-b border-neutral-200 dark:border-neutral-600 pb-4 mb-6">
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input id="current_password" name="current_password" type="password" 
                class="mt-1 block w-full rounded-xl border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-300 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400" 
