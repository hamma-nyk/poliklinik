<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-300">
            <div>
                <h2 class="font-bold text-2xl text-neutral-800 dark:text-neutral-100 leading-tight tracking-tight">
                    {{ __('WhatsApp Service Gateway') }}
                </h2>
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400 font-medium">Manajemen koneksi bot notifikasi otomatis</p>
            </div>
    ...
    <div class="py-12 bg-neutral-50 dark:bg-neutral-900 min-h-screen transition-colors duration-300" 
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-[2.5rem] p-10 shadow-sm border border-neutral-200 dark:border-neutral-700 transition-all">
                <div class="flex items-center justify-between mb-10">
                    <div class="flex items-center gap-4">
                        ...
                        <h3 class="text-sm font-bold text-neutral-700 dark:text-neutral-200 uppercase tracking-[0.2em]" x-text="serviceName"></h3>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="flex flex-col items-center justify-center p-8 bg-neutral-50 dark:bg-neutral-900/50 rounded-[2rem] border-2 border-dashed border-neutral-200 dark:border-neutral-700 min-h-[350px] transition-all">
                        ...
                        <template x-if="status === 'connected'">
                            <div class="text-center space-y-4" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-90">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-widest mb-1">Session Active</p>
                                    <h4 class="text-2xl font-bold text-neutral-800 dark:text-white tracking-tight" x-text="connectedNumber"></h4>
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="status === 'qr_ready'">
                            <div class="text-center space-y-6" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 transform translate-y-4">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-[10px] text-neutral-400 dark:text-neutral-500 italic animate-pulse">Scan QR Code melalui WhatsApp Linked Devices</p>
                                </div>
                            </div>
                        </template>
                    ...
                    <div class="space-y-6">
                        <div class="p-6 bg-indigo-50 dark:bg-neutral-700 rounded-3xl border border-indigo-100 dark:border-neutral-600 transition-all">
                        ...
                        <div class="flex items-start gap-3 px-2">
                            ...
                            <p class="text-[10px] text-neutral-400 dark:text-neutral-500 italic leading-relaxed">
            ...
            <div class="bg-neutral-900 rounded-[2rem] p-8 shadow-2xl border border-neutral-800 overflow-hidden relative group">
                ...
                <div class="flex items-center justify-between mb-6 relative z-10">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-xs font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-[0.2em]">Live Activity Log</h3>
                    </div>
                ...
                <div class="h-56 overflow-y-auto font-mono text-[11px] space-y-2 text-neutral-400 custom-scrollbar pr-4" id="log-container">
                    <template x-for="log in logs">
                        <div class="flex gap-4 border-l-2 border-neutral-800 pl-4 py-0.5 hover:bg-neutral-800/30 transition-colors">
                            <span class="text-neutral-600 shrink-0 font-bold" x-text="log.time"></span>
