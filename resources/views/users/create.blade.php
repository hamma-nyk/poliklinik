    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Manajemen akun pengguna dan konfigurasi hak akses</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-6">
                            ...
                            <p class="text-xs text-neutral-500 dark:text-neutral-400 mb-6 italic">Pilih modul yang diizinkan untuk diakses oleh user ini:</p>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach($permissions as $permission)
                                    <label class="flex items-center p-4 border rounded-md cursor-pointer transition-all duration-200 border-neutral-200 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-900/50">
