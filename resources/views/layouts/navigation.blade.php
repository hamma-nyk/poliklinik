...
<div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
     class="fixed inset-y-0 left-0 z-30 w-72 bg-slate-900 text-white transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-0 flex flex-col border-r border-slate-800 shadow-2xl">
    ...
    <div class="flex items-center justify-between h-20 px-6 bg-slate-900 border-b border-slate-800">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
            ...
            <div class="flex flex-col">
                <span class="text-lg font-bold tracking-wide text-white">POLIKLINIK</span>
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <a href="{{ route('dashboard') }}" 
           class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('dashboard') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('view_master_data')
            <a href="{{ route('master.employees.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('master.employees.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
            ...
            <a href="{{ route('master.doctors.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('master.doctors.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
            ...
            <a href="{{ route('master.nurses.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('master.nurses.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
            ...
            <a href="{{ route('master.patients.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('master.patients.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('view_master_medicine')
            <a href="{{ route('inventory.medicines.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('inventory.medicines.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('view_medicine_history')
            <a href="{{ route('inventory.transactions.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('inventory.transactions.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('view_clinical')
            <a href="{{ route('clinical.records.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('clinical.records.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
            ...
            <a href="{{ route('clinical.lab.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('clinical.lab.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('laporan')
            <a href="{{ route('clinical.reports.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('clinical.reports.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @can('manage_users')
            <a href="{{ route('users.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('users.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
        ...
        @role('superadmin')
            <a href="{{ route('permissions.index') }}" 
               class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('permissions.*') ? 'bg-blue-600/10 text-blue-400' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
    ...
    <div class="absolute bottom-0 left-0 w-full p-4 border-t border-slate-800 bg-slate-900 z-10">
        <div x-data="{ userOpen: false }" class="relative">
            <button @click="userOpen = !userOpen" class="flex items-center w-full p-2 rounded-xl hover:bg-slate-800 transition-colors duration-200 group focus:outline-none">
                ...
                <div class="ml-3 text-left overflow-hidden">
                    ...
                    <p class="text-xs text-slate-500 truncate group-hover:text-blue-400 transition-colors">Lihat Profil</p>
                </div>
            ...
            <div x-show="userOpen" 
                 ...
                 class="absolute bottom-16 left-0 w-full bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden py-1 z-50">
                
                <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 text-sm text-slate-300 hover:bg-slate-700 hover:text-white transition-colors">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a href="{{ route('logout') }}" 
                       ...
                       class="flex items-center px-4 py-3 text-sm text-red-400 hover:bg-slate-700 hover:text-red-300 transition-colors">
