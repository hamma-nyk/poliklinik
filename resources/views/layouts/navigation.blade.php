...
<div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
     class="fixed inset-y-0 left-0 z-30 w-64 bg-neutral-950 text-neutral-50 transition-all duration-300 ease-in-out md:translate-x-0 md:static md:inset-0 flex flex-col border-r border-neutral-200 dark:border-neutral-800 shadow" >

    <div class="flex items-center justify-between h-[86px] px-6 bg-white dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800 transition-colors duration-300">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar bg-neutral-50 dark:bg-neutral-950 transition-colors duration-300">
    ...
    <div class="absolute bottom-0 left-0 w-full p-4 border-t bg-neutral-50 border-neutral-200 dark:border-neutral-800 dark:bg-neutral-950 z-10 transition-colors duration-300">
        <div x-data="{ userOpen: false }" class="relative">
            <button @click="userOpen = !userOpen" class="flex items-center w-full p-2 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-900 transition-colors focus:outline-none">
            ...
            <div x-show="userOpen" 
                 ...
                 class="absolute bottom-14 left-0 w-full bg-white border border-neutral-200 dark:bg-neutral-950 dark:border-neutral-800 rounded-md shadow-md overflow-hidden py-1 z-50">
                
                <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 transition-colors">
                ...
                <button 
                    ...
                    "
                    type="button"
                    class="flex items-center w-full px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 transition-colors"
                >
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a href="{{ route('logout') }}" 
                       ...
                       class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-neutral-100 dark:text-red-500 dark:hover:bg-neutral-800 transition-colors">
