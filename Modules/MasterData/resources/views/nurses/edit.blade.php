    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">Pembaruan informasi profil dan status kepegawaian</p>
            </div>
            <div class="hidden md:flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                <span class="hover:text-neutral-900 dark:hover:text-neutral-50 cursor-pointer transition-colors"><a href="{{ route('master.nurses.index') }}">Perawat</a></span>
            ...
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 p-6 sm:p-8"
                ...
                <form action="{{ route('master.nurses.update', $nurse->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <label class="flex items-center p-4 border rounded-md cursor-pointer transition-all duration-200" 
                                   :class="type == 'karyawan' ? 'border-neutral-900 bg-neutral-100 dark:border-neutral-50 dark:bg-neutral-800' : 'border-neutral-200 dark:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-700/50'">
                                <input type="radio" name="type" value="karyawan" x-model="type" class="w-4 h-4 text-neutral-900 focus:ring-neutral-950 border-neutral-300 dark:border-neutral-600 dark:bg-neutral-800 dark:checked:bg-neutral-50 dark:focus:ring-neutral-300">
                                <span class="ml-3 block text-sm font-medium leading-none">Internal (Karyawan)</span>
                            </label>
                            
                            <label class="flex items-center p-4 border rounded-md cursor-pointer transition-all duration-200"
                                   :class="type == 'eksternal' ? 'border-neutral-900 bg-neutral-100 dark:border-neutral-50 dark:bg-neutral-800' : 'border-neutral-200 dark:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-700/50'">
                                <input type="radio" name="type" value="eksternal" x-model="type" class="w-4 h-4 text-neutral-900 focus:ring-neutral-950 border-neutral-300 dark:border-neutral-600 dark:bg-neutral-800 dark:checked:bg-neutral-50 dark:focus:ring-neutral-300">
                    ...
                    <div x-show="type == 'karyawan'" class="mb-6 rounded-md border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-900 shadow-sm dark:border-sky-800 dark:bg-sky-950 dark:text-sky-200 p-6">
                        ...
                        <select id="employee_selector" name="employee_id" class="flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-sky-200 bg-white dark:bg-neutral-800 px-3 py-1 text-sm shadow-sm ring-offset-white focus:outline-none focus:ring-1 focus:ring-neutral-950 dark:border-sky-800 dark:ring-offset-neutral-950">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2 space-y-2">
                                <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-neutral-500">ID System (Read Only)</label>
                                <input type="text" value="{{ $nurse->code }}" disabled class="flex h-9 w-full rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-sm shadow-sm transition-colors dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-400 font-mono cursor-not-allowed">
                            </div>
                            ...
                            <div x-show="type == 'karyawan'" class="space-y-2">
                                ...
                                <input type="text" name="nik" id="nik" value="{{ old('nik', $nurse->nik) }}" class="flex h-9 w-full rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-sm shadow-sm transition-colors dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-400 font-mono" readonly>
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $nurse->nama) }}" class="flex h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-600 dark:placeholder:text-neutral-400 dark:focus-visible:ring-neutral-300" :readonly="type == 'karyawan'" :class="type == 'karyawan' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400' : ''" required>
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Nomor STR</label>
                            <input type="text" name="str" value="{{ old('str', $nurse->str) }}" class="flex h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-600 dark:placeholder:text-neutral-400 dark:focus-visible:ring-neutral-300">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $nurse->phone) }}" class="flex h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-600 dark:placeholder:text-neutral-400 dark:focus-visible:ring-neutral-300">
                        </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-600 flex flex-col sm:flex-row justify-end gap-3">
                        ...
                        <button type="submit" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90 h-9 px-4 py-2 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90">Simpan Perubahan</button>
                    </div>
                </form>
