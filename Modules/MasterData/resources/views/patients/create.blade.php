<x-app-layout>
    ...
    <div class="py-6 flex-1 space-y-4">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-8" x-data="{ tab: 'employee' }">
                ...
                <form action="{{ route('master.patients.store') }}" method="POST">
                    ...
                    {{-- Tab Switcher --}}
                    <div class="flex p-1 space-x-1 rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900 mb-8">
                        <button type="button" @click="tab = 'employee'"
                                :class="tab === 'employee' ? 'bg-white dark:bg-neutral-950 shadow text-neutral-900 dark:text-neutral-50' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-50'"
                                class="w-full py-2.5 text-sm font-medium leading-5 rounded-md transition-all duration-200">
                            Pilih dari Karyawan
                        </button>
                        <button type="button" @click="tab = 'general'"
                                :class="tab === 'general' ? 'bg-white dark:bg-neutral-950 shadow text-neutral-900 dark:text-neutral-50' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-50'"
                                class="w-full py-2.5 text-sm font-medium leading-5 rounded-md transition-all duration-200">
                            Input Manual (Umum)
                        </button>
                    </div>
