    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="hidden md:flex items-center text-sm text-slate-500 mt-2 md:mt-0 dark:text-slate-400">
                ...
                <span class="font-semibold text-slate-900 dark:text-slate-50">Pasien</span>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b border-slate-200 transition-colors hover:bg-slate-100/50 dark:border-slate-800 dark:hover:bg-slate-800/50">
                                ...
                                <th class="h-12 px-4 text-left align-middle font-medium text-slate-500 dark:text-slate-400">ID & Kategori</th>
                                <th class="h-12 px-4 text-left align-middle font-medium text-slate-500 dark:text-slate-400">Jenis Kelamin & Usia</th>
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b border-slate-100 transition-colors hover:bg-slate-100/50 dark:border-slate-800 dark:hover:bg-slate-800/50 group">
                                <td class="p-4 align-middle whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4 grid gap-0.5">
                                            ...
                                            <div class="text-xs text-slate-500 dark:text-slate-400">{{ $patient->nik ? "NIK: ".$patient->nik : "KTP: ".$patient->ktp }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-4 align-middle whitespace-nowrap">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded-full mb-3 text-slate-300 dark:text-slate-500">
