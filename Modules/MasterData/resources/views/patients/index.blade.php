                ...
                <div class="overflow-x-auto">
                    <table class="w-full caption-bottom text-sm">
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b border-neutral-100 transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50 group">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        <div class="bg-neutral-50 dark:bg-neutral-900 p-4 rounded-full mb-3 text-neutral-300 dark:text-neutral-500">
