                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="md:col-span-2 flex flex-col sm:flex-row gap-4">
                            ...
                            <div class="flex-1 space-y-2">
                                ...
                                <div class="flex h-9 w-full rounded-md border border-slate-200 bg-slate-100 px-3 py-1 text-sm shadow-sm dark:border-slate-800 dark:bg-slate-800 dark:text-slate-400 font-medium flex items-center">
