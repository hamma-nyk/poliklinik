                    ...
                    <table class="w-full caption-bottom text-sm">
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b border-neutral-100 transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                ...
                                <td class="p-4 align-middle">
                                    <div class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors border-transparent bg-neutral-100 text-neutral-900 hover:bg-neutral-100/80 dark:bg-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-800/80">
                                        {{ $doc->specialization }}
                                    </div>
                                </td>
