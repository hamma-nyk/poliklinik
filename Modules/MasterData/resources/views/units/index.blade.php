<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800">{{ __('Master Unit (Sub Sub Bagian)') }}</h2>
    </x-slot>
    ...
    <div class="py-12" x-data="{ openImport: false }">
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-6 py-4 font-mono font-bold text-slate-700">{{ $unit->code }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="px-6 py-6 text-center text-slate-400 italic">Belum ada data unit.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div x-show="openImport" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm" x-cloak>
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6" @click.away="openImport = false">
                <h3 class="text-lg font-bold mb-4 text-slate-800">Import Data Unit</h3>
