    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Pembaruan informasi produk dan penyesuaian harga jual</p>
            </div>
            <div class="hidden md:flex items-center text-sm text-neutral-500 mt-2 md:mt-0 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Edit Obat</span>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <input type="text" value="{{ $medicine->code }}" disabled 
                                class="flex h-9 w-full rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-sm shadow-sm transition-colors dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-400 font-mono cursor-not-allowed uppercase">
                        </div>
                        ...
                        <!-- {{-- Harga --}}
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Harga Jual (Rp) <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <span class="text-neutral-400 dark:text-neutral-500 text-sm font-bold">Rp</span>
                                </div>
                                <input type="number" name="price" value="{{ $medicine->price }}"
                                    class="w-full rounded-xl border-neutral-200 dark:border-neutral-600 bg-neutral-50 dark:bg-neutral-700 dark:text-neutral-100 pl-10 focus:border-indigo-500 focus:ring-indigo-500 transition-all" required min="0">
                            </div>
                        </div> -->
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="flex items-center gap-4 p-4 bg-neutral-50 dark:bg-neutral-700/30 rounded-xl border border-neutral-200 dark:border-neutral-700">
                                <div class="px-5 py-2 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-600">
                                    <span class="text-xl font-black text-neutral-900 dark:text-neutral-50">{{ $medicine->current_stock }}</span>
                                    <span class="ml-1 text-xs font-bold text-neutral-500 uppercase">{{ $medicine->unit }}</span>
                                </div>
                                <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed italic">
