    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Log mutasi pergerakan item secara mendetail</p>
            </div>
            <div class="flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Stock Card</span>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <div class="flex gap-3 text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                ...
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 text-center">Keluar</th>
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 text-center">Sisa Stok</th>
                            </tr>
                        </thead>
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50 bg-neutral-50/50 dark:bg-neutral-900/50">
                                ...
                                <td class="p-4 align-middle text-center text-neutral-300 dark:text-neutral-700">-</td>
                                <td class="p-4 align-middle text-center text-neutral-300 dark:text-neutral-700">-</td>
                            ...
                            @forelse($transactions as $item)
                                ...
                                <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                    ...
                                    <td class="p-4 align-middle">
                                        ...
                                        <div class="text-xs text-neutral-500 dark:text-neutral-400 mt-1 italic">
