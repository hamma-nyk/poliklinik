<x-app-layout>
    ...
    <div class="py-6 flex-1 space-y-4"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('inventory.transactions.store') }}" method="POST" @submit.prevent="$el.submit()">
                ...
                <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-8 mb-6">
        ...
        <div class="relative z-1"> {{-- Z-index tinggi --}}
            ...
            <div x-show="showSupplierDropdown" 
                ...
                <ul class="py-1">
                    ...
                    <template x-for="sup in filteredSuppliers" :key="sup.id">
                        <li @click="selectSupplier(sup)" 
                            class="cursor-pointer relative flex w-full select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none hover:bg-neutral-100 hover:text-neutral-900 dark:hover:bg-neutral-800 dark:hover:text-neutral-50">
                ...
                <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-8">
    ...
    <template x-for="(item, index) in items" :key="index">
        <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50 align-top">
            ...
            <td class="p-4 align-middle relative w-5/12">
                ...
                <div x-show="item.showDropdown" 
                     class="absolute z-50 w-full mt-1 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md shadow-md max-h-56 overflow-y-auto">
                    <ul class="py-1">
            ...
            <td class="p-4 align-middle">
                <input type="text" x-model="item.unit" readonly class="flex h-9 w-full rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-sm shadow-sm transition-colors dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-400 font-mono cursor-not-allowed text-center">
            </td>

            {{-- KOLOM JUMLAH --}}
            <td class="p-4 align-middle">
                <input type="number" :name="'items['+index+'][quantity]'" x-model="item.quantity" min="1" class="flex h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 dark:border-neutral-800 dark:focus-visible:ring-neutral-300" required>
            </td>
            ...
            <td class="p-4 align-middle">
                <div class="relative">
                    ...
                    <input type="number" 
                           ...
                           class="flex h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 dark:border-neutral-800 dark:focus-visible:ring-neutral-300 pl-8" 
                           placeholder="8000">
                </div>
            </td>
            ...
            <td class="p-4 align-middle">
                <div class="relative">
                    ...
                    <input type="number" 
                        ...
                        step="0.01"
                        readonly 
                        class="flex h-9 w-full rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-sm shadow-sm transition-colors dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-400 font-mono cursor-not-allowed pl-8">
                </div>
            </td>
