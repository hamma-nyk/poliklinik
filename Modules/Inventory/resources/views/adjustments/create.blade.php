                    ...
                    <div class="space-y-3 relative">
                        ...
                        <template x-if="selectedId">
                            <div class="mt-4 p-4 rounded-xl border flex items-center justify-between animate-in fade-in slide-in-from-top-2 duration-300"
                                :class="type === 'out' ? 'bg-rose-50/50 border-rose-100 text-rose-700 dark:bg-neutral-800 dark:border-rose-900/30 dark:text-rose-400' : 'bg-emerald-50/50 border-emerald-100 text-emerald-700 dark:bg-neutral-800 dark:border-emerald-900/30 dark:text-emerald-400'">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <div class="absolute right-4 flex items-center pointer-events-none border-l border-neutral-200 dark:border-neutral-600 pl-3 h-6 text-neutral-500 dark:text-neutral-400">
