    ...
    <div class="py-6 flex-1 space-y-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('inventory.stock-opnames.store') }}" method="POST">
                ...
                {{-- Form Administrasi --}}
                <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-6 mb-8 transition-all">
                ...
                {{-- Tabel Opname --}}
                <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 overflow-hidden mb-8 transition-all">
                        ...
                        <table class="w-full caption-bottom text-sm">
                            ...
                            <tbody class="[&_tr:last-child]:border-0">
                                ...
                                <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50 group">
                                    ...
                                    <td class="p-4 align-middle">
                                        <span class="px-2.5 py-1 bg-neutral-100 dark:bg-neutral-700 rounded-lg text-[10px] font-black text-neutral-500 dark:text-neutral-400 border border-neutral-200 dark:border-neutral-800 uppercase tracking-widest">
                                            {{ $med->unit }}
                                        </span>
                                    </td>
                ...
                {{-- Aksi --}}
                <div class="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-800 flex flex-col sm:flex-row justify-end gap-3 mb-12">
