    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-300">
        ...
        <div class="flex flex-wrap items-center justify-center md:justify-start gap-2">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Nomor Stok Opname: {{ $opname->opname_number }}</p>
            </div>
            <!-- <span class="hidden sm:block mx-2 text-neutral-300 dark:text-neutral-600 font-light">/</span>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 p-6 grid grid-cols-1 md:grid-cols-4 gap-8 transition-all">
                ...
                <div class="md:col-span-2 space-y-1">
                    <span class="block text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Memo / Catatan Dokumen</span>
                    <span class="block text-lg font-semibold text-neutral-900 dark:text-neutral-50 italic">
...
{{-- Overview Info & Visual Chart --}}
                ...
                <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 p-6 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 pb-8 border-b border-neutral-200 dark:border-neutral-600">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Oleh Petugas</p>
                                <p class="text-lg font-semibold text-neutral-900 dark:text-neutral-50">{{ $opname->creator->name ?? 'System' }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b border-neutral-200 transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50 text-[11px] font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400">
                                ...
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Keterangan</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Status Audit</th>
                            </tr>
                        </thead>
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b border-neutral-200 transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50 group">
                                <td class="p-4 align-middle">
									...
									<div class="text-[10px] text-neutral-500 dark:text-neutral-400 font-mono font-bold tracking-widest uppercase italic">
										{{ $item->medicine->code ?? '-' }} ? {{ $item->medicine->unit ?? '-' }}
									</div>
								</td>
                                
                                <td class="p-4 align-middle text-center">
                                    <span class="text-sm font-black text-neutral-500 dark:text-neutral-400 tabular-nums">
                                ...
                                <td class="p-4 align-middle text-center">
                                    ...
                                    @else
                                        <span class="font-bold tabular-nums text-neutral-500 dark:text-neutral-400">0</span>
                                    @endif
                                </td>
            ...
            <div class="rounded-md border border-neutral-200 bg-neutral-50 dark:bg-neutral-800 dark:border-neutral-600 p-6 flex items-start gap-4">
                ...
                <div>
                    <h4 class="text-xs font-semibold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 mb-1">Informasi Penyesuaian Sistem</h4>
                    <p class="text-[11px] leading-relaxed font-medium italic text-neutral-500 dark:text-neutral-400">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const options = {
                ...
                grid: {
                    borderColor: isDark ? '#404040' : '#f5f5f5',
                    strokeDashArray: 4,
