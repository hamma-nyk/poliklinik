    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-300">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Monitoring penyesuaian stok fisik vs sistem</p>
            </div>
            <div class="flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Stock Opname</span>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 p-4 flex flex-col md:flex-row justify-between items-center gap-4 transition-all">
                ...
                <div class="w-full md:w-auto">
                    <a href="{{ route('inventory.stock-opnames.create') }}" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90 h-9 px-4 py-2 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90 w-full md:w-auto uppercase tracking-wider">
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50 text-[11px] font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400">
                                ...
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400">Petugas</th>
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50 group">
                                <td class="p-4 align-middle whitespace-nowrap">
                                    ...
                                    <div class="text-[11px] mt-0.5 font-medium italic text-neutral-500 dark:text-neutral-400">
                                        {{ $opname->created_at->format('H:i') }} WIB
                                    </div>
                                </td>
                                <td class="p-4 align-middle">
                                    <span class="inline-flex items-center rounded-md border border-transparent bg-neutral-900 text-neutral-50 px-2.5 py-0.5 text-xs font-semibold dark:bg-neutral-50 dark:text-neutral-900 font-mono uppercase">
                            ...
                            <tr>
                                <td colspan="5" class="p-4 align-middle text-center py-24">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm mt-1 max-w-sm mx-auto italic leading-relaxed text-neutral-500 dark:text-neutral-400">Riwayat Stok Opname akan muncul di sini setelah Anda melakukan penyesuaian stok inventaris.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
