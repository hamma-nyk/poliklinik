    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-300">
            ...
            <div class="flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Arsip SKD</span>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 p-6 flex flex-col md:flex-row justify-between items-center gap-4 transition-all">
                ...
                <div class="w-full md:w-auto shrink-0">
                    <a href="{{ route('clinical.sick-leaves.create') }}" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90 h-9 px-4 py-2 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90">
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                ...
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400">Durasi Izin</th>
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 text-center">Aksi</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50 group">
                                <td class="p-4 align-middle whitespace-nowrap">
                                    <div class="grid gap-0.5">
                                        ...
                                        <div class="text-xs text-neutral-500 dark:text-neutral-400 font-mono">{{ \Carbon\Carbon::parse($letter->created_at)->format('d M Y') }}</div>
                                    </div>
                                </td>
                                <td class="p-4 align-middle">
                                    <div class="font-bold text-neutral-800 dark:text-neutral-200 text-base leading-none mb-1 group-hover:text-indigo-600 transition-colors">{{ $letter->patient->name }}</div>
                                    <div class="text-[10px] text-neutral-400 dark:text-neutral-500 font-mono font-semibold tracking-widest uppercase italic">{{ $letter->patient->nik }}</div>
                                </td>
                                <td class="p-4 align-middle">
                                ...
                                <td class="p-4 align-middle">
                                    <div class="text-sm font-bold text-neutral-700 dark:text-neutral-200">{{ $letter->duration_days }} Hari</div>
                                    <div class="text-[10px] text-neutral-500 dark:text-neutral-400 font-mono italic leading-tight">
                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                <td colspan="5" class="p-4 align-middle text-center bg-white dark:bg-neutral-950">
                                    <div class="flex flex-col items-center justify-center py-10">
                                        ...
                                        <p class="text-neutral-400 dark:text-neutral-500 text-sm mt-1 max-w-xs mx-auto italic leading-relaxed text-center">Coba gunakan kata kunci lain atau ubah filter untuk mencari arsip surat keterangan sakit.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
