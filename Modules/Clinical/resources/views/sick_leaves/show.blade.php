    ...
    <div class="py-6 flex-1 space-y-4">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 overflow-hidden transition-all">
                ...
                {{-- Header Status --}}
                <div class="bg-neutral-50 dark:bg-neutral-800 px-8 py-5 border-b border-neutral-200 dark:border-neutral-600 flex justify-between items-center">
                    ...
                    @else
                        <span class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors border-neutral-200 text-neutral-950 dark:border-neutral-600 dark:text-neutral-50">Eksternal (RS Luar)</span>
                    @endif
                </div>
                ...
                <div class="p-6 space-y-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 pb-8 border-b border-neutral-200 dark:border-neutral-600">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="rounded-md border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm text-neutral-900 shadow-sm dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50">
                    ...
                    <div class="rounded-md border border-neutral-200 bg-neutral-50 dark:bg-neutral-800 dark:border-neutral-600 p-6">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="p-2 border border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-800 rounded-md shadow-sm text-neutral-900 dark:text-neutral-50">
