    ...
    <div class="py-6 flex-1 space-y-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-50 overflow-hidden">
                ...
                {{-- ID Header --}}
                <div class="bg-neutral-50/50 dark:bg-neutral-800/50 px-8 py-6 border-b border-neutral-200 dark:border-neutral-600 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="space-y-4">
                                <div class="rounded-md border border-neutral-200 bg-neutral-50 dark:bg-neutral-800 dark:border-neutral-600 p-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="rounded-md border border-neutral-200 bg-neutral-50 dark:bg-neutral-800 dark:border-neutral-600 p-4">
                                        ...
                                        <span class="inline-flex items-center rounded-md border {{ $record->patient->type == 'karyawan' ? 'border-transparent bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50' : 'border-neutral-200 text-neutral-950 dark:border-neutral-600 dark:text-neutral-50' }} px-2.5 py-0.5 text-xs font-semibold uppercase">
                                            {{ $record->patient->type }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <tbody class="[&_tr:last-child]:border-0 divide-y divide-neutral-200 dark:divide-neutral-800">
                                    ...
                                    <tr class="border-b border-neutral-200 transition-colors hover:bg-neutral-100/50 dark:hover:bg-neutral-700/50">
                                        ...
                                        <td class="p-4 align-middle text-center">
                                            <span class="inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold text-neutral-950 dark:border-neutral-600 dark:text-neutral-50">{{ $item->quantity }}</span>
                                        </td>
                    ...
                    {{-- Tanda Tangan --}}
                    <div class="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-600 flex justify-end">
