<x-app-layout>
   ...
   class="inline-flex items-center px-5 py-2 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-500/30 text-sm group">
