<x-app-layout title="Laporan SKD">
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-300">
            <div class="flex items-center gap-3">
                <!-- <div class="p-2 bg-indigo-50 dark:bg-neutral-700 rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-0.5">Ekspor data surat keterangan sakit berkala</p>
                </div>
            </div>
            <div class="flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Export Report</span>
            </div>
        </div>
    </x-slot>
    ...
    <button type="submit" 
        class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90 h-9 px-4 py-2 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90 w-full sm:flex-1">
