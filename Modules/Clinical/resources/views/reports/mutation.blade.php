<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-1 dark:text-neutral-400">Monitoring pergerakan keluar-masuk item logistik medis</p>
            </div>
            <div class="flex items-center text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <span class="font-semibold text-neutral-900 dark:text-neutral-50">Mutasi Obat</span>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="w-full caption-bottom text-sm">
                        <thead class="[&_tr]:border-b">
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50">
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400 w-16">No</th>
                                <th class="h-12 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400">Detail Item Obat</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Satuan</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Total Masuk</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Total Keluar</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400">Stok Akhir</th>
                                <th class="h-12 px-4 text-center align-middle font-medium text-neutral-500 dark:text-neutral-400 w-20">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-600 dark:hover:bg-neutral-700/50">
                                ...
                                <td class="p-4 align-middle">
                                    ...
                                    <div class="text-xs text-neutral-500 dark:text-neutral-400">{{ $row->code }}</div>
                                </td>
                                <td class="p-4 align-middle text-center">
                                    <span class="px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded-md text-xs font-medium text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-600">
                                        {{ $row->unit }}
                                    </span>
                                </td>
    ...
    <a href="{{ url('/inventory/reports/stock-card') }}?medicine_id={{ $row->id }}&start_date={{ $startDate }}&end_date={{ $endDate }}" 
       class="inline-flex p-2 text-neutral-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-xl transition-all"
