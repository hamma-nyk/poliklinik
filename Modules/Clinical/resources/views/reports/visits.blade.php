                            ...
                            <tr class="border-b transition-colors hover:bg-neutral-100/50 dark:border-neutral-800 dark:hover:bg-neutral-800/50">
                                ...
                                <td class="p-4 align-middle">
                                    <div class="flex items-center">
                                        ...
                                        @else
                                        <div class="h-9 w-9 rounded-md bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700 flex items-center justify-center text-xs font-medium mr-3">
                                            {{ substr($name, 0, 2) }}
                                        </div>
                                        <div>
                                    ...
                                    @if($row->medicineTransactions->isNotEmpty())
                                        <div class="space-y-1.5">
                                            @foreach($row->medicineTransactions as $trans)
                                                ...
                                                <div class="flex items-start justify-between gap-4 text-xs border-b border-neutral-100 dark:border-neutral-800 pb-1 last:border-0 transition-colors">
