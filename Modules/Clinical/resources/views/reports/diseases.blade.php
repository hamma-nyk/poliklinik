                ...
                <form method="GET" action="{{ route('clinical.reports.diseases') }}" class="flex flex-col md:flex-row gap-6 items-end">
                    ...
                    <div class="flex gap-2 w-full md:w-auto">
                        ...
                        <button type="submit" name="action" value="excel" formtarget="_blank" 
                            class="flex-1 md:flex-none bg-emerald-600 text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-emerald-700 transition-all flex items-center justify-center shadow-lg shadow-emerald-200 dark:shadow-none">
